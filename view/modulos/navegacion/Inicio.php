            ...
            <ul class="header-cart-wrapitem w-full">
                <li class="header-cart-item flex-w flex-t m-b-12">
                    <div class="header-cart-item-img">
                        <img src="view/presentacion/ecommerce/images/item-cart-01.jpg" alt="IMG">
                    </div>
...
<section class="section-slide">
    <div class="wrap-slick1">
        <div class="slick1">
            <?php 
            $query = $conexion->query("SELECT * FROM slider ORDER BY id DESC limit 1");
            while ($row = mysqli_fetch_array($query)) { ?>
                <div class="item-slick1" style="background-image: url(view/presentacion/ecommerce/imagenes/slider/' <?php echo $row['ruta_imagen']; ?> ');">
                ...
                <div class="item-slick1" style="background-image: url(view/presentacion/ecommerce/imagenes/slider/slide-04.jpg);">
                    <div class="container h-full">
                        <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
